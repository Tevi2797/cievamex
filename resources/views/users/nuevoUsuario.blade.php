...
<h1 class="titulo1" align="center">Registrar Nuevo Usuario</h1>
...
<div class="form-row">
    ...
    <input type="text" class="bordeform bordeform form-control border-top-0 border-right-0 border-left-0 @error('nombre') is-invalid @enderror" id="nombre" name="nombre" value="{{ old('nombre')}}" placeholder="" required>
        @error('nombre')
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" class="valido bordeform form-control border-top-0 border-right-0 border-left-0 @error('apellidos') is-invalid @enderror" id="apellidos" name="apellidos" value="{{ old('apellidos')}}" placeholder="" required>
        @error('apellidos')
        <div class="invalid-feedback">
             {{$message}}
        </div>
  ...
  <div class="form-group">
    ...
    <select class="form-control @error('tipo') is-invalid @enderror"  id="tipo" name="tipo"  required>
      ...
      <option value="tecnico" {{ old('tipo') == "tecnico" ? 'selected' : '' }}>Asesor técnico</option>

      <option value="campo" {{ old('tipo') == "campo" ? 'selected' : '' }}>Asesor de campo</option>

    <option value="productor" {{ old('tipo') == "productor" ? 'selected' : '' }}>Productor</option>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control @error('telefono') is-invalid @enderror" id="telefono" value="{{ old('telefono')}}" name="telefono" placeholder="5510998745" required="required">
    @error('telefono')
        <div class="invalid-feedback">
            {{$message}}
        </div>
  ...
  <div class="form-group">
  	  ...
  	  <select  class="form-control" id="cargo" name="cargo" >
            ...
            <option value="{{$cargo->id}}" {{ old('cargo') == $cargo->id ? 'selected' : '' }}> {{$cargo->nombre}}</option>
   ...
   <div class="form-check">
    ...
    <input type="checkbox" class="form-check-input @error('terminos') is-invalid @enderror" id="terminos" name="terminos" required="">
...
<br>
    ...
    <input type="submit" id="btn_crear_u" name="boton" value="Guardar" class="btn btn-primary btn-lg btn-block fondoVerde">
